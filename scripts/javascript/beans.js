...
function sunClicked() {
    ...
    if (clicked === false) {
        ...
        document.getElementById("sun").style.width = "30px";
        document.getElementById("sun").style.height = "30px";
        ...
        document.getElementById("sun").style.width = "20px";
        document.getElementById("sun").style.height = "20px";
